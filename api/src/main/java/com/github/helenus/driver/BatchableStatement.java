...
/**
 * The <code>BatchableStatement</code> interface is used to identify statements
 ...
 * @since 1.0
 */
public interface BatchableStatement<R, F extends ListenableFuture<R>>
  extends GenericStatement<R, F>, SequenceableStatement<R, F> {}
