 ...
 * which will create all the required elements (i.e. keyspace, tables, indexes)
 * to support the schema for a given POJO. It will take care of creating the
 * required keyspace, tables, and indexes and will also insert any initial
 * objects defined by the POJO.
 * <p>
...
public interface CreateSchema<T>
   ...
   * will be creating a keyspace and all defined tables and indexes for the POJO
   * class. It will then be a representation of the query strings for the keyspace
   * and each table and index creation similar to a "BATCH" statement.
   *
   * @author paouelle
   *
   ...
   * to the keyspace, tables, and indexes creation.
   * <p>
