...
/**
 * The <code>IntCodecProvider</code> class defines a provider suitable to
 * decode the {@link DataType#INT} data type.
 *
 ...
 * @since 1.0
 */
public final class IntCodecProvider implements CodecProvider {
  /**
   * Holds the single instance of this provider.
   *
   * @author paouelle
   */
  public final static CodecProvider INSTANCE = new IntCodecProvider();

  /**
   * Instantiates a new <code>IntCodecProvider</code> object.
   *
   * @author paouelle
   */
  ...
  public <T> TypeCodec<T> codecFor(Class<T> clazz)
    ...
    if ((Integer.class == clazz) || (Integer.TYPE == clazz)) {
      return (TypeCodec<T>)TypeCodec.cint();
    }
