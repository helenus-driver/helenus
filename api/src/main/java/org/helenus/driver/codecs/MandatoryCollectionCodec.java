...
/**
 * The <code>MandatoryCollectionCodec</code> class provides an implementation
 ...
 * @since 3.0
 */
public class MandatoryCollectionCodec<E, T extends Collection<E>>
  extends TypeCodec<T> {
  /**
  ...
  /**
   * Holds the supplier to use for creating empty collections.
   *
   * @author paouelle
   */
   ...
   * @author paouelle
   *
   * @param icodec the codec to use to decode collections
   * @param supplier the supplier to use for creating empty collections
   */
  public MandatoryCollectionCodec(TypeCodec<T> icodec, Supplier<T> supplier) {
