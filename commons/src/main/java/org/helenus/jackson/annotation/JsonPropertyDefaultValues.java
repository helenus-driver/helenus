...
/**
 * The <code>JsonPropertyDefaultValues</code> annotation is used to indicate that
...
@Documented
@JacksonAnnotation
public @interface JsonPropertyDefaultValues {
  /**
   * Defines the default values for the annotated property if not specified.
   *
   * @author paouelle
   *
   * @return the default values for the property if not specified
   */
   ...
   * @author paouelle
   *
   * @return the classes from which to get the default values for the property
   *         if not specified
   */
  Class<?>[] valueFromClass() default {};
}
