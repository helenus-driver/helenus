...
/**
 * The <code>JsonPropertyMaximumValue</code> annotation is used to indicate the
...
public @interface JsonPropertyMaximumValue {
   ...
   * @author paouelle
   *
   * @return the maximum value for the annotated property or its contained
   *         values
   */
   ...
   * @author paouelle
   *
   * @return <code>true</code> if the maximum value is exclusive;
   ...
   * @author paouelle
   *
   * @return the maximum value for the annotated property contained keys
   */
  double[] key() default {};
