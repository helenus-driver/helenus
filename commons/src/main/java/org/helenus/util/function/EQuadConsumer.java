...
/**
 * The <code>EQuadConsumer</code> interface expands on the {@link QuadConsumer}
 * interface to provide the ability to throw back exceptions.
 *
 * @copyright 2015-2016 The Helenus Driver Project Authors
 *
 * @author  The Helenus Driver Project Authors
 * @version 1 - Apr 22, 2016 - paouelle - Creation
 *
...
public interface EQuadConsumer<T, U, V, X, E extends Throwable> {
  ...
  /**
   * Returns a composed {@code EQuadConsumer} that performs, in sequence, this
