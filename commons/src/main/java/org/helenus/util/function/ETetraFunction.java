...
/**
 * The <code>ETetraFunction</code> interface represents a function that accepts
 ...
 */
@FunctionalInterface
public interface ETetraFunction<T, U, V, X, R, E extends Throwable> {
  /**
   ...
   */
  public R apply(T t, U u, V v, X x) throws E;
}
