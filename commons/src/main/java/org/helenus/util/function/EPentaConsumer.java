...
/**
 * The <code>EPentaConsumer</code> interface expands on the {@link TetraConsumer}
 ...
 * @param <Y> the type of the fifth argument to the operation
...
public interface EPentaConsumer<T, U, V, X, Y, E extends Throwable> {
   ...
   */
  public void accept(T t, U u, V v, X x, Y y) throws E;

  /**
   * Returns a composed {@code EPentaConsumer} that performs, in sequence, this
