...
public class CreateIndexImpl<T>
   ...
   * @author paouelle
   *
   * @see com.github.helenusdriver.driver.CreateIndex#ifNotExists()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenusdriver.driver.CreateIndex#where(com.github.helenusdriver.driver.Clause)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenusdriver.driver.CreateIndex#where()
   */
  @Override
  ...
  public static class BuilderImpl<T> implements Builder<T> {
     ...
     * @author paouelle
     *
     * @see com.github.helenusdriver.driver.CreateIndex.Builder#usingClass(java.lang.String)
     */
    @Override
     ...
     * @author paouelle
     *
     * @see com.github.helenusdriver.driver.CreateIndex.Builder#on(java.lang.String[])
     */
    @Override
     ...
     * @author paouelle
     *
     * @see com.github.helenusdriver.driver.CreateIndex.Builder#onAll()
     */
    @Override
  ...
  public static class WhereImpl<T>
     ...
     * @author paouelle
     *
     * @see com.github.helenusdriver.driver.CreateIndex.Where#and(com.github.helenusdriver.driver.Clause)
     */
    @Override
