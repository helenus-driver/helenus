...
public abstract class ClauseImpl
  ...
  static class SimpleClauseImpl extends ClauseImpl {
     ...
     * @author paouelle
     *
     * @see com.github.helenusdriver.driver.impl.ClauseImpl#firstValue()
     */
    @Override
    Object firstValue() {
      return value;
     ...
     * @author paouelle
     *
     * @see com.github.helenusdriver.driver.impl.ClauseImpl#values()
     */
    @Override
    Collection<?> values() {
     ...
     * @author paouelle
     *
     * @see com.github.helenusdriver.driver.impl.ClauseImpl#getOperation()
     */
    @Override
    String getOperation() {
      return op;
     ...
     * @author paouelle
     *
     * @see com.github.helenusdriver.driver.impl.ClauseImpl#validate(com.github.helenusdriver.driver.impl.TableInfoImpl)
     */
    @Override
  ...
  static class IsClauseImpl extends ClauseImpl implements Delayed {
     ...
     * @author paouelle
     *
     * @see com.github.helenusdriver.driver.impl.ClauseImpl.Delayed#processWith(com.github.helenusdriver.driver.impl.TableInfoImpl)
     */
     ...
     * @author paouelle
     *
     * @see com.github.helenusdriver.driver.impl.ClauseImpl.Delayed#processWith(com.github.helenusdriver.driver.impl.ClassInfoImpl)
     */
    @SuppressWarnings("unchecked")
    @Override
    public <T> List<ClauseImpl> processWith(ClassInfoImpl<T> cinfo) {
  ...
  static class IsObjectClauseImpl extends ClauseImpl implements DelayedWithObject {
     ...
     * @author paouelle
     *
     * @see com.github.helenusdriver.driver.impl.ClauseImpl.DelayedWithObject#processWith(com.github.helenusdriver.driver.impl.TableInfoImpl, com.github.helenusdriver.driver.impl.ClassInfoImpl.POJOContext)
     */
    @Override
    public <T> List<ClauseImpl> processWith(
      TableInfoImpl<T> table, ClassInfoImpl<T>.POJOContext context
