...
public class CreateTypeImpl<T>
   ...
   * @author paouelle
   *
   * @see com.github.helenusdriver.driver.CreateType#ifNotExists()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenusdriver.driver.CreateType#where(com.github.helenusdriver.driver.Clause)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenusdriver.driver.CreateType#where()
   */
  @Override
  ...
  public static class WhereImpl<T>
     ...
     * @author paouelle
     *
     * @see com.github.helenusdriver.driver.CreateType.Where#and(com.github.helenusdriver.driver.Clause)
     */
    @Override
