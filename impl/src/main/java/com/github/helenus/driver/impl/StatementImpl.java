...
import com.github.helenus.driver.ObjectSet;
import com.github.helenus.driver.ObjectSetFuture;
...
public abstract class StatementImpl<R, F extends ListenableFuture<R>, T>
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#getKeyspace()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#setConsistencyLevel(com.datastax.driver.core.ConsistencyLevel)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#getConsistencyLevel()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#setSerialConsistencyLevel(com.datastax.driver.core.ConsistencyLevel)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#getSerialConsistencyLevel()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#enableTracing()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#disableTracing()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#isTracing()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#setRetryPolicy(com.datastax.driver.core.policies.RetryPolicy)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#getRetryPolicy()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#setFetchSize(int)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#getFetchSize()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#getQueryString()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#execute()
   */
  @SuppressWarnings("unchecked")
  @Override
  public R execute() {
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#executeAsync()
   */
  @Override
  @SuppressWarnings("unchecked")
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#executeRaw()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.GenericStatement#executeAsyncRaw()
   */
  @Override
