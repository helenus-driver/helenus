...
public class BatchImpl
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.Batch#isEmpty()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.Batch#hasReachedRecommendedSize()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.Batch#size()
   */
  @Override
  public int size() {
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.Batch#clear()
   */
  @Override
  public void clear() {
    statements.clear();
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.Batch#add(com.github.helenus.driver.BatchableStatement)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.Batch#duplicate()
   */
  @Override
  ...
  public static class OptionsImpl
     ...
     * @author paouelle
     *
     * @see com.github.helenus.driver.Batch.Options#and(com.github.helenus.driver.Using)
     */
    @Override
     ...
     * @author paouelle
     *
     * @see com.github.helenus.driver.Batch.Options#add(com.github.helenus.driver.BatchableStatement)
     */
    @Override
     ...
     * @author paouelle
     *
     * @see com.github.helenus.driver.Batch.Options#add(com.datastax.driver.core.RegularStatement)
     */
    @Override
