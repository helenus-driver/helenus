...
import com.github.helenus.driver.GenericStatement;
...
public abstract class ForwardingStatementImpl<R, F extends AbstractFuture<R>, T, S extends StatementImpl<R, F, T>>
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#appendOptions(java.lang.StringBuilder)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#buildQueryString()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#setDirty()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#isDirty()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#isCounterOp()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#setCounterOp(boolean)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#getObjectClass()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#getContext()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#getPOJOContext()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#setConsistencyLevel(com.datastax.driver.core.ConsistencyLevel)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#getConsistencyLevel()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#setSerialConsistencyLevel(com.datastax.driver.core.ConsistencyLevel)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#getSerialConsistencyLevel()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#enableTracing()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#disableTracing()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#isTracing()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#setRetryPolicy(com.datastax.driver.core.policies.RetryPolicy)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#getRetryPolicy()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#setFetchSize(int)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#getFetchSize()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#execute()
   */
  @Override
  public R execute() {
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#executeRaw()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.StatementImpl#executeAsyncRaw()
   */
  @Override
