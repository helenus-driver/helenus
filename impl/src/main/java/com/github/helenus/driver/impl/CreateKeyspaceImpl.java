...
public class CreateKeyspaceImpl<T>
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.CreateKeyspace#ifNotExists()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.CreateKeyspace#with(com.github.helenus.driver.KeyspaceWith)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.CreateKeyspace#with()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.CreateKeyspace#where(com.github.helenus.driver.Clause)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.CreateKeyspace#where()
   */
  @Override
  ...
  public static class OptionsImpl<T>
     ...
     * @author paouelle
     *
     * @see com.github.helenus.driver.CreateKeyspace.Options#and(com.github.helenus.driver.KeyspaceWith)
     */
    @Override
     ...
     * @author paouelle
     *
     * @see com.github.helenus.driver.CreateKeyspace.Options#where(com.github.helenus.driver.Clause)
     */
    @SuppressWarnings("synthetic-access")
    @Override
    public Where<T> where(Clause clause) {
     ...
     * @author paouelle
     *
     * @see com.github.helenus.driver.CreateKeyspace.Options#where()
     */
    @SuppressWarnings("synthetic-access")
    @Override
    public com.github.helenus.driver.CreateKeyspace.Where<T> where() {
  ...
  public static class WhereImpl<T>
     ...
     * @author paouelle
     *
     * @see com.github.helenus.driver.CreateKeyspace.Where#and(com.github.helenus.driver.Clause)
     */
    @Override
