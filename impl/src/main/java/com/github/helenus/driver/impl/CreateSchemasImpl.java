...
public class CreateSchemasImpl
  ...
  private Map<Keyspace, List<ClassInfoImpl<?>>> findKeyspaces() {
    ...
    for (final Class<?> clazz: reflections.getTypesAnnotatedWith(
      com.github.helenus.persistence.Entity.class, true
    )) {
    ...
    for (final Class<?> clazz: reflections.getTypesAnnotatedWith(
      com.github.helenus.persistence.RootEntity.class, true
    )) {
      // skip classes that are not directly annotated
      if (ReflectionUtils.findFirstClassAnnotatedWith(
           clazz, com.github.helenus.persistence.RootEntity.class
         ) != clazz) {
        continue;
      }
      final ClassInfoImpl<?> cinfo = mgr.getClassInfoImpl(clazz);
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.impl.SequenceStatementImpl#appendGroupType(java.lang.StringBuilder)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.CreateSchemas#getObjectClasses()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.CreateSchemas#getClassInfos()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.CreateSchemas#getDefinedClassInfos()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.CreateSchemas#ifNotExists()
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.CreateSchemas#where(com.github.helenus.driver.Clause)
   */
  @Override
   ...
   * @author paouelle
   *
   * @see com.github.helenus.driver.CreateSchemas#where()
   */
  @Override
  public Where where() {
    return where;
